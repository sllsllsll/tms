            ...
            $.ajax({
                ...
                success: function (data) {
                    $.each(data, function (i, dom) {
                        $("#myid").append("<th field='cb' checkbox='true'></th><th field='rid' width='20' align='center'>" + dom.rid + "</th><th field='rolename' width='20' align='center'>" + dom.rolename
                            + "</th><th field='action' width='20' align='center'>分配权限</th>");
...
<table id="dg" title="角色管理" class="easyui-datagrid"
       ...
       url="${pageContext.request.contextPath}/role/RoleList" fit="true" toolbar="#tb">
    <thead id="ths">

    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="rid" width="80" align="center">编码</th>
