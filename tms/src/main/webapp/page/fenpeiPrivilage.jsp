            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, dom) {
                        alert(dom.username)
                        $("#myid").append("<th field='cb' checkbox='true'></th><th field='userid' width='20' align='center'>" + dom.userid + "</th><th field='username' width='20' align='center'>" + dom.username
                            + "</th><th field='action' width='20' align='center'>分配角色</th>");
        ...
        function yhli() {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var html = "";
                    $.each(data, function (i, dom) {
                        html += "<ul><li>" + dom.name + "<input type='checkbox'/>";
                        $.each(dom.chirdern, function (g, item) {
                            html += "<ul><li><input type='checkbox'/>" + item.name + "</li></ul>";
                        });
                        html += "</li></ul>";
                    });
                    $("#fm").append(html);
...
<table id="dg" title="用户管理" class="easyui-datagrid"
       ...
       url="${pageContext.request.contextPath}/user/UserInfoList" fit="true" toolbar="#tb">
    <thead id="ths">

    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="userid" width="80" align="center">编码</th>
